      ...
      <div className="row wrapper">
        <div className="col-10 col-lg-5 updateprofile">
          <form onSubmit={submitHandler}>
            ...
            <div className="form-group">
              <label htmlFor="new_passoword_field"> New Password</label>
              <input
                type="password"
            ...
            <div className="form-group">
              <label htmlFor="new_passoword_confirm_field">
                New Passoword Confirm
              </label>
              <input
                type="password"
            ...
            <button type="submit" className="btn-block py-3 passowrd-btn">
              Update Password
            </button>
          </form>
        </div>
